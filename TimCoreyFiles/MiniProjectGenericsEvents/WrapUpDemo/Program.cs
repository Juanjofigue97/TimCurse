...
namespace WrapUpDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            peopleData.SaveToCSV(people, @"E:\Curso_c#\TimCurse\TimCoreyFiles\MiniProjectGenericsEvents\Files\people.csv");

            DataAccess<CarModel> carData = new DataAccess<CarModel>();
            carData.BadEntryFound += CarData_BadEntryFound;

            carData.SaveToCSV(cars, @"E:\Curso_c#\TimCurse\TimCoreyFiles\MiniProjectGenericsEvents\Files\cars.csv");
