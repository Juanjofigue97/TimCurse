...
builder.Services.AddSwaggerGen(opts =>
{
    ...
    var terms = new Uri("http://localhost:5196/terms");
    ...
    {
        Name = "Juan Jose Figueroa",
        Email = "help@juanjo.figue.com"
    };

    opts.SwaggerDoc("v1", new OpenApiInfo()
    {
        Version = "v1",
        Title = $"{title} v1 (Deprecarted)",
        Description = description + "deprecated because ...",
